		...
		<div class="dropdown mx-3 mt-2">
			...
			<i class="fa-solid fa-bars text-primary"></i>
				...
				<div class="dropdown-menu dropdown-menu-end" aria-labelledby="orederStatistics">
							<li><?= $this->Html->link(__('Edit Hostel'), ['action' => 'edit', $hostel->id], ['class' => 'dropdown-item', 'escapeTitle' => false]) ?></li>
				<li><?= $this->Form->postLink(__('Delete Hostel'), ['action' => 'delete', $hostel->id], ['confirm' => __('Are you sure you want to delete # {0}?', $hostel->id), 'class' => 'dropdown-item', 'escapeTitle' => false]) ?></li>
				<li><hr class="dropdown-divider"></li>
				<li><?= $this->Html->link(__('List Hostels'), ['action' => 'index'], ['class' => 'dropdown-item', 'escapeTitle' => false]) ?></li>
				<li><?= $this->Html->link(__('New Hostel'), ['action' => 'add'], ['class' => 'dropdown-item', 'escapeTitle' => false]) ?></li>
							</div>
		</div>
    </div>
</div>
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <div class="card-body text-body-secondary">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <?php foreach ($hostel->hostels as $hostels) : ?>
                        <tr>
                            <td><?= h($hostels->id) ?></td>
            ...
            <div class="card-body text-body-secondary">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <?php foreach ($hostel->rooms as $rooms) : ?>
                        <tr>
                            <td><?= h($rooms->id) ?></td>
            ...
            <div class="card-body text-body-secondary">
                ...
                <?php if (!empty($hostel->complaints)) : ?>
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($hostel->complaints as $complaints) : ?>
                        <tr>
