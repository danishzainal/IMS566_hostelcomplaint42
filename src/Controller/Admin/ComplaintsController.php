...
class ComplaintsController extends AppController
{
    ...
    public function view($id = null)
    {
        ...
        $complaint = $this->Complaints->get($id, contain: ['Hostels', 'Rooms']);
...
public function add()
{
    ...
    $system_name = 'Hostel Complaint System';
    ...
    // Fetch dropdown lists from associations
  ...
  $this->set(compact(
    ...
    public function edit($id = null)
    {
		...
		$hostels = $this->Complaints->Hostels->find('list', limit: 200)->all();
		$rooms = $this->Complaints->Rooms->find('list', limit: 200)->all();
        $this->set(compact('complaint', 'hostels', 'rooms'));
    }
