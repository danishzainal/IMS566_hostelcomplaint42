		...
		?>
            ...
            <tbody>
				...
				<td><?php echo $counter++ ?></td>
                    ...
                    <td><?= $complaint->hasValue('student') ? $this->Html->link($complaint->student->name, ['controller' => 'Students', 'action' => 'view', $complaint->student->id]) : '' ?></td>
                    ...
                    <td><?= $complaint->hasValue('room') ? $this->Html->link($complaint->room->room_id, ['controller' => 'Rooms', 'action' => 'view', $complaint->room->id]) : '' ?></td>
                    <td><?= h($complaint->action) ?></td>
