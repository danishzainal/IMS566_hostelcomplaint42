    ...
    <div class="px-0">
        <ul class="list-unstyled components">
            ...
            <?php if ($this->Identity->isLoggedIn()) { ?>
                ...
                <li class="menu-item <?= $c_name == 'Complaints' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="fa-regular fa-comment"></i> Complaints'), ['controller' => 'Complaints', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <li class="menu-item <?= $c_name == 'Students' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="fa-solid fa-graduation-cap"></i> Students'), ['prefix' => 'Admin', 'controller' => 'Students', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Staffs' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="fa-solid fa-people-roof"></i> Staffs'), ['prefix' => 'Admin', 'controller' => 'Staffs', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Rooms' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="fa-solid fa-person-shelter"></i> Rooms'), ['prefix' => 'Admin', 'controller' => 'Rooms', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Hostels' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="fa-solid fa-house-chimney-window"></i> Hostels'), ['prefix' => 'Admin', 'controller' => 'Hostels', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Complaints' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="fa-solid fa-comment"></i>Complaints'), ['prefix' => 'Admin', 'controller' => 'Complaints', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                <?php } ?>
            <?php } ?>
        </ul>
